...
function persist(){ map.title=$('#map-title').value.trim()||'無題のマップ'; localStorage.setItem('mindflow-map',JSON.stringify(map)); $('#save-status').textContent='ローカルに保存済み'; }
